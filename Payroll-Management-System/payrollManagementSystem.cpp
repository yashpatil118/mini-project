...
employee emp[max1],tempemp[max1];
...
void saveUserToFile(const unordered_map<string, string>& users) {
...
bool verifyUser(const unordered_map<string, string>& users, const string& username, const string& password) {
...
void login()
{
    unordered_map<string, string> allUsers;
    ...
    string UserName,Password;char ch;int i=0,flag;
     ...
     switch(flag)
     {
         case 1:   system("cls");
                   loginFrame1();
                    ...
                    if (allUsers.find(UserName) != allUsers.end()) {
                        ...
                        loginFrame1();
                        gotoXY(25,10);
                        printf("Username already exists!!!\a");
                        gotoXY(20,12);
                   ...
                   while(1)
                    ...
                    pwd = Password;
                    allUsers[UserName] = pwd;
                    saveUserToFile(allUsers);
                    system("cls");
                    loginFrame1();
                    gotoXY(25,10);
                    printf("Registered Successfully!!!\a");
                    gotoXY(20,12);
                    cout<<"Will be redirected in 3 Seconds...";
                        gotoXY(56,12);
                    Cdelay(1000);
         ...
         case 2:    system("cls");
                   ...
                   while(1)
                    ...
                    pwd1 = newPassword;
                    if(verifyUser(allUsers,newUserName,pwd1))
                    {
                        system("cls");
                        loginFrame1();
                        gotoXY(27,10);
...
void insert()
{
    ...
    borderNoDelay();
    int i=num;
    int PF,TAX,HRA,MealA,MedicalA,TransportA,LoanBal,LoanDeb,DA;
    long int sal,h;
    char loan;
    num+=1;
    gotoXY(28,4);
    ...
    do {
       ...
       cout<<"Years of Experience : ";
        if (!(cin >> exp)) {
            ...
            cin.ignore(numeric_limits<streamsize>::max(), '\n');
            gotoXY(10, 14);
            cout << "Invalid input! Please enter a valid Experience.";
...
void intro()
{
    ...
    gotoXY(20,11); printf("Yash Patil");
    gotoXY(20,13); printf("https://github.com/yashpatil118");
    gotoXY(20,15); printf("https://www.linkedin.com/in/yash-patil-069820252/");
